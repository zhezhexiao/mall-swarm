...
Invoke `/research-author` for architecture analysis, code review, and system design discussions. The Skill auto-triggers on edits to `mall-ai/**/*.{java,yml,xml}`; invoke manually for `.md` / `.sh` or pure-discussion contexts.
